...
int readMultiInt (int sock, msgIntType *m1, msgIntType *m2)  		; // Functii  de citire/scriere pentru MultiInt
...
int writeMultiInt (int sock, msgHeaderType h, int i1, int i2) ;		// Construieste mesajul si il trimite
