...
/* AICI clientul citeste ecuatii scrise natural si le transforma in sistem Ax=b. */
int main(int argc, char *argv[])
{
    ...
    /* ---- Conectare la server ---- */
    /* AICI clientul se conecteaza la server pentru a trimite sistemul obtinut prin parsare. */
    ...
    msgHeaderType h;
    msgIntType    mi;
    /* AICI se face handshake-ul initial. */
    ...
    /* ---- OPR_SOLVE ---- */
    /* AICI sistemul derivat din ecuatiile text este trimis spre rezolvare. */
    h.opID = OPR_SOLVE;
